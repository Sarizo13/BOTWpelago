...
class BotWWorld(World):
    ...
    def generate_output(self, output_directory: str) -> None:
        ...
        # Only shrine chests need the rando to place a placeholder; other categories
        # (shrine completion, towers, beasts, places, quests, memories) are detected
        # by their own gamedata flags and need no rando placement.
        placements = {
